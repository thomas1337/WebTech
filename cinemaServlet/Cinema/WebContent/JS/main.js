...
function displayAllSeats () {
    ...
    jsonRequest("GET", "http://localhost:8080/web/cinema?movie="+movieID, drawFetchedReservedSeats);
...
function buyTicket(){
    ...
    jsonRequest("POST", "http://localhost:8080/web/cinema", handleReservationRequestResult, JSON.stringify(reservation));
